...
void RobotArm::setJoints(const double* rads, size_t size) {
    if (size >= 4) {
        ...
        sts_bus2.WritePosEx(15, radToSTS(rads[1], false), 1500, 20);
        sts_bus1.WritePosEx(12, radToSTS(rads[2], false), 1500, 20);
        sts_bus2.WritePosEx(14, radToSTS(rads[3], false), 1500, 20); 
    }
}
