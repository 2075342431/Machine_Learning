...
struct Entity_
{
  ...
  static constexpr uint8_t PUBLISHER =
    0u;
  static constexpr uint8_t SUBSCRIBER =
    1u;
  static constexpr uint8_t SERVICE_SERVER =
    2u;
  static constexpr uint8_t SERVICE_CLIENT =
    3u;
...
constexpr uint8_t Entity_<ContainerAllocator>::PUBLISHER;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t Entity_<ContainerAllocator>::SUBSCRIBER;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t Entity_<ContainerAllocator>::SERVICE_SERVER;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t Entity_<ContainerAllocator>::SERVICE_CLIENT;
#endif  // __cplusplus < 201703L
